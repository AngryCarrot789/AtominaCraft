package reghzy.atominacraft.collision;
...
public class AxisAlignedBB {
    ...
    public Vector3 intersectDirection(AxisAlignedBB aabb) {
        Vector3 intersect = getIntersectAmount(aabb);
        ...
        else if (intersect.z < intersect.x && intersect.z < intersect.y) {
            amount.y = 1.0f;
        }
        return amount;
    }
    ...
    public Vector3 getIntersectAmount(AxisAlignedBB box) {
        return new Vector3(getIntersectAmountX(box),
                           getIntersectAmountY(box),
                           getIntersectAmountZ(box));
    }
