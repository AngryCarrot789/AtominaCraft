package reghzy.atominacraft.client.render.shader;
...
public class PinkShader extends Shader {
    public int vertexId;
    public int fragmentId;

    public int mvpId;

    public PinkShader(File vertexFile, File fragmentFile) {
        ...
        GL20.glBindAttribLocation(this.programId, 0, "in_pos");
